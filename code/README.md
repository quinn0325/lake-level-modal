...
| Directory | Role |
| --- | --- |
| `00_data_generation/` | source-data functions plus Modal entry points for screening, panel construction and embedding selection |
...
and cloud implementations. Local scripts in stages 06–08 only render products
from downloaded results.
